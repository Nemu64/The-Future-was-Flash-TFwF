...
function oneclick() {
    ...
    button.innerHTML='<button class="button" onclick="oneclick2()">ver. 5.7.4</button>';
}
function oneclick2() {
    dev.innerHTML='You are 3 steps away from becoming a developer!';
    button.innerHTML='<button class="button" onclick="oneclick3()">ver. 5.7.4</button>';
}
function oneclick3() {
    dev.innerHTML='You are 2 steps away from becoming a developer!';
    button.innerHTML='<button class="button" onclick="oneclick4()">ver. 5.7.4</button>';
}
function oneclick4() {
    dev.innerHTML='You are 1 step away from becoming a developer!';
    button.innerHTML='<button class="button" onclick="oneclick5()">ver. 5.7.4</button>';
}
function oneclick5() {
    ...
    button.innerHTML='<button class="button" onclick="oneclick6()">ver. 5.7.4</button>';
}
function oneclick6() {
    ...
    button.innerHTML='<button class="button" disabled=true onclick="oneclick6()">ver. 5.7.4</button>';
}