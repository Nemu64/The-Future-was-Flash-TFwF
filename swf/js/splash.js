...
var clickcount = 5;
function oneclick() {
    if (clickcount > 2) {dev.innerHTML = "You are", clickcount - 1, "steps away from becoming a developer"}
